...
- `compat-cmd-wrapper = 0`：默认主模式，直接发送 `0x7204/0x7205`
- `compat-cmd-wrapper = 1`：兼容模式，发送 `0x7101 + cmd_id`

默认以协议文档为准，兼容模式仅在对端设备明确要求时启用。
