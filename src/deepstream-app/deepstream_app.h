...
typedef enum
{
    ...
    CUAV_CORNER_ZOOM_CYCLE_PHASE_HOLD_HOME_VISIBLE_PRESET = 4,
    ...
    CUAV_CORNER_ZOOM_CYCLE_PHASE_SEND_ZOOM_IN_STOP = 10,
    CUAV_CORNER_ZOOM_CYCLE_PHASE_SEND_ZOOM_OUT = 11,
    CUAV_CORNER_ZOOM_CYCLE_PHASE_HOLD_ZOOM_OUT = 12,
    CUAV_CORNER_ZOOM_CYCLE_PHASE_SEND_ZOOM_OUT_STOP = 13,
    CUAV_CORNER_ZOOM_CYCLE_PHASE_COMPLETE = 14
